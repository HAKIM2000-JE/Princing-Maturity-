  ...
  setscore(10-index)
    ...
    return (
        ...
        <span className="text-blue-700 ">75%</span>
          ...
          <Progress  color="#304EE8" completed={75}  className="rounded-3xl" />
          
        </div>
        <h1 className=" home_title md:text-xl  px-12 py-7 w-10/12 relative xl:top-20  text-[13px]  " >How would you rate the quality of your data regarding product, revenue, margin and client?</h1>
          ...
          <h1 className={`option_paragraph   position relative top-2 xl:left-9 ${font1} ` }  > I DONT KNOW </h1>
          <h1 className={`option_paragraph position relative top-10 xl:top-2 right-5  w-36 ${font2} ` }  >Not very reliable, no interconnection between Inventory/Financial/CRM <br/> /commercial/ ERP databasesy</h1>
          
          <h1 className={`option_paragraph position relative top-2  w-56 xl:left-2   ${font3}  ` }  >Limited reliability, some interconnection between Inventory/Financial/CRM/commercial   ERP databases </h1>
         
          <h1 className={`option_paragraph    position relative top-2 w-56 left-5   ${font4} ` }  >  Full reliability, full interaconnection between Inventory/Financial/CRM/commercial/ ERP databases</h1>
