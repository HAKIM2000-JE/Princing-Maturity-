...
useEffect(() => {
   ...
   const removeselect = ()=>{
    ...
    return (
        ...
        <div className=" px-12 ">
        <span className="text-blue-700 ">54%</span>
          
          <Progress  color="#304EE8" completed={48}  className="rounded-3xl" />
          
        </div>
        <h1 className=" home_title text-xl  px-12 py-7 w-11/12 " >Do you have dedicated pricing FTE?</h1>
          ...
          <h1 className={`option_paragraph position relative top-2  w-56 xl:left-9  ${font3}  ` }  > I have one Pricing manager/analyst who is supporting the business units</h1>
          <h1 className={`option_paragraph position relative top-10 xl:top-2 xl:left-28   w-44 ${font2} ` }  > I do not have any person in charge of pricing - Pricing is managed by </h1>
          ...
          <h1 className={`option_paragraph   position relative top-2 xl:left-9 ${font1} ` }  > I DONT KNOW </h1>
          <h1 className={`option_paragraph position relative top-10 xl:top-2 right-5  w-36 ${font2} ` }  > I do not have any person in charge of pricing - Pricing is managed by</h1>
          
          <h1 className={`option_paragraph position relative top-2  w-56 xl:left-2   ${font3}  ` }  > I have one Pricing manager/analyst who is supporting the business units </h1>
         
          <h1 className={`option_paragraph    position relative top-2 w-56 left-5   ${font4} ` }  >  I have a dedicated pricing team empowered to manage pricing</h1>
