  ...
  setscore(10-index)
    ...
    return (
        ...
        <h1 className=" home_title text-xl  px-12 py-7 w-10/12 relative xl:top-20 " >How closely are pricing decisions monitored?</h1>
          ...
          <h1 className={`option_paragraph   position relative top-2 xl:left-9 ${font1} ` }  > I DONT KNOW </h1>
          <h1 className={`option_paragraph position relative top-10 xl:top-2 right-5  w-36 ${font2} ` }  >There is no specific pricing dashboard. Pricing is only monitored indirectly by looking at sales volumes and margin levels</h1>
          
          <h1 className={`option_paragraph position relative top-2  w-56 xl:left-2   ${font3}  ` }  >There are few pricing dashboards and pricing is occasionally reviewed as part of performance review </h1>
         
          <h1 className={`option_paragraph    position relative top-2 w-56 left-5   ${font4} ` }  >  Pricing decisions are monitored vey closely by management and best practices are shared to ensure continuous improvement</h1>
