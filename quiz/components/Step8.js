...
useEffect(() => {
   ...
   const removeselect = ()=>{
    ...
    return (
        ...
        <div className=" px-12 ">
        <span className="text-blue-700 ">33%</span>
          
          <Progress  color="#304EE8" completed={33}  className="rounded-3xl" />
          
        </div>
        <h1 className=" home_title text-xl  px-12 py-7 w-11/12 " >Do you have a fixed inventory and fluctuating demand that requires to adjust pricing dynamically ?</h1>
          ...
          <h1 className={`option_paragraph   position relative top-2 xl:left-9 ${font1} ` }  > I DONT KNOW </h1>
          <h1 className={`option_paragraph position relative top-10 xl:top-2 right-5  w-36 ${font2} ` }  > Yes, my inventory is fixed or has low flexibility and I need to adapt permanetly my pricing to demand/offer ebalance </h1>
          
          <h1 className={`option_paragraph position relative top-2  w-56 xl:left-2   ${font3}  ` }  > My product has a certain lifetime and I need to consider some stock or capacity limitations when adjusting the price </h1>
         
          <h1 className={`option_paragraph    position relative top-2 w-56 left-5   ${font4} ` }  > No, my inventory is not limited and I do not have to take this in consideration when setting the price</h1>
