...
function Step2( {formData, navigation}) {
    ...
    const choices = ['>5M', '2M TO 5M' , '1M TO 2M' ,'500K TO 1M' , '100k TO 100K' , '100K TO 500K' , '4K TO 10K' ,'2K TO 4K' ,'500 To 2k','0 To 500' , 'I DONT KNOW']
...
const showBar = (index)=>{
    ...
    return (
        ...
        <h1 className=" home_title text-xl  px-12 py-7 w-10/12 " >HOW MANY <span className="text-blue-700">SKU</span>  YOUR COMPANY IS OFFERING ?</h1>
