...
useEffect(() => {
   ...
   const removeselect = ()=>{
    ...
    return (
        ...
        <div className=" px-12 ">
        <span className="text-blue-700 ">48%</span>
          
          <Progress  color="#304EE8" completed={48}  className="rounded-3xl" />
          
        </div>
        <h1 className=" home_title text-xl  px-12 py-7 w-11/12 " >How are pricing decisions taken?</h1>
          ...
          <h1 className={`option_paragraph position relative top-10 xl:top-2 xl:left-28   w-44 ${font2} ` }  >Pricing decisions are made without any analysis. This is more based on business sense and/or budget needs </h1>
          ...
          <h1 className={`option_paragraph   position relative top-2 xl:left-9 ${font1} ` }  > I DONT KNOW </h1>
          <h1 className={`option_paragraph position relative top-10 xl:top-2 right-5  w-36 ${font2} ` }  > Pricing decisions are made without any analysis. This is more based on business sense and/or budget needs</h1>
          
          <h1 className={`option_paragraph position relative top-2  w-56 xl:left-2   ${font3}  ` }  > Pricing decisions are made based on competition tracking and some high level pricing guidelines </h1>
         
          <h1 className={`option_paragraph    position relative top-2 w-56 left-5   ${font4} ` }  > Pricing decisions are made based on pricing performance analysis and/or pricing research with differentiated rules by SKU & pier pricing</h1>
