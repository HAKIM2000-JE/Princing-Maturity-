  ...
  setscore(10-index)
    ...
    return (
        ...
        <span className="text-blue-700 ">30%</span>
          ...
          <Progress  color="#304EE8" completed={30}  className="rounded-3xl" />
          
        </div>
        <h1 className=" home_title md:text-xl  px-12 py-7 w-10/12 relative xl:top-20  text-[13px]  " >How differentiated your offer is from what competition is offering ?</h1>
