...
useEffect(() => {
   ...
   const removeselect = ()=>{
    ...
    return (
        ...
        <div className=" px-12 ">
        <span className="text-blue-700 ">28%</span>
          
          <Progress  color="#304EE8" completed={28}  className="rounded-3xl" />
          
        </div>
        <h1 className=" home_title text-xl  px-12 py-7 w-11/12 " >How differentiated your offer is from what competition is offering ?</h1>
          ...
          <h1 className={`option_paragraph   position relative top-2 xl:left-9 ${font1} ` }  > I DONT KNOW </h1>
          <h1 className={`option_paragraph position relative top-10 xl:top-2 right-5  w-36 ${font2} ` }  > My product is very similar to what competition is offering, price is a key decision driver </h1>
          
          <h1 className={`option_paragraph position relative top-2  w-56 xl:left-2   ${font3}  ` }  > My product is somehow comparable to the one of competition, pricing plays a role, but is not the only decision driver </h1>
         
          <h1 className={`option_paragraph    position relative top-2 w-56 left-5   ${font4} ` }  > My product is quite unique, price is more about the value of my product, competition is less important </h1>
